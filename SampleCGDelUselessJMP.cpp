//===-- SampleCGDelUselessJMP.cpp - SampleCG DelJmp -------------------------------===//
//
...
static cl::opt<bool> EnableDelJmp(
  "enable-samplecg-del-useless-jmp",
  cl::init(true),
...
namespace {
  struct DelJmp : public MachineFunctionPass {
    ...
    StringRef getPassName() const {
      return "SampleCG Del Useless jmp";
    }
...
runOnMachineBasicBlock(MachineBasicBlock &MBB, MachineBasicBlock &MBBN) {
  ...
  if (I->getOpcode() == SampleCG::JMP && I->getOperand(0).getMBB() == &MBBN) {
...
/// createSampleCGDelJmpPass - Returns a pass that DelJmp in SampleCG MachineFunctions
FunctionPass *llvm::createSampleCGDelJmpPass(SampleCGTargetMachine &tm) {
